    ...
    >
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6 max-w-8xl mx-auto mb-4">
            {specialties.map((specialty, index) => (
              <button
               key={specialty.id ?? index}
        onClick={() => handleHeroSearch(specialty.name)}
        className="group bg-white hover:bg-gradient-to-br hover:from-[#0c213e] hover:to-[#1a3557] border-1 border-gray-200 hover:border-[#0c213e] p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 rounded-full w-45 h-45 cursor-pointer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {mainServices.map((service, index) => (
              ...
              >
                ...
                <div className="p-8">
                  <div
                    className={`w-56 h-56 bg-gradient-to-br ${service.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                  >

                    <video src="https://cdnl.iconscout.com/lottie/premium/preview-watermark/video-call-with-doctor-animation-gif-download-7516331.mp4?h=240" autoPlay loop muted></video>
                  </div>
                  {/* <div
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-sm">
            <p>
              &copy; 2026 HealthCare. All rights reserved. | Privacy Policy |
              Terms of Service
            </p>
          </div>
        </div>
